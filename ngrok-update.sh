...
# Install: see comments at the bottom of this file.
#
# Requirements on the Pi:
#   sudo npm install -g twilio-cli     (or: sudo snap install twilio)
#   ngrok config add-authtoken <token>
#   Fill in the four variables below (or export them as env vars before running).
