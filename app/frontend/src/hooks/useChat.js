...
const SYSTEM_PROMPT = `Talk Box helps you find the right local service quickly — just describe what you need in plain English.
Do not include sensitive information; conversations may be reviewed during development.
Talk Box is experimental — double-check important information before acting on it.
